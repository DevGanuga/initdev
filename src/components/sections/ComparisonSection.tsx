...
const criteria = [
  ...
  { key: 'enterprise', label: 'Seniors with Fortune-500 production experience' },
...
const alternatives: Alternative[] = [
  ...
  },
  {
    ...
    bottomLine: '6-figure minimums. Layers of project managers. The seniors who ran Fortune-500 systems pitch you — then your project gets the junior bench. Ours build it themselves.',
  },
];
