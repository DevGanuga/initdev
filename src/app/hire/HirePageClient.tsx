...
const stats = [
  { value: '8', label: 'products built end to end at initdev' },
...
const experience = [
  {
    ...
    org: 'initdev studio',
    period: '2025 - present',
    type: 'the studio\u2019s lead builder on 6 products',
    description:
      'initdev hands me the builds where ai unreliability meets money, privacy or clinical data, and the engineering has to absorb the difference. i own every technical decision from first schema to production incident. 1,197 github contributions in the last twelve months, 96% of them shipped commits.',
    bullets: [
      'dyia. field-service saas taken from zero to live production revenue: tiered stripe billing, anthropic business intelligence, sentry monitoring, documented qa packs gating every release.',
      'drip. privacy-first ai companion: dual-store memory (postgres plus pinecone) with ownership-scoped retrieval and cross-store rollback. 98 api routes, 38 migrations, sole author.',
      'ai blueprint. real-money credit economy for ai generation: atomic sql spend, credits escrowed during generation, automatic refunds on model failure, idempotent stripe webhooks.',
      'convoai studio. 672-line typed tavus api v2 client and a clinical triage pipeline: video conversation, claude symptom extraction, pdf report, automated delivery.',
      'animalia. headless shopify commerce: typed domain layer over 33 graphql operations, deterministic merchandising engine, ai photography pipeline writing back to the admin api.',
      'inflio. 119k-loc ai video platform built solo. closed after market validation with a professional wind-down: 14,600 dead lines removed, clean build.',
    ],
  },
  {
    ...
    description:
      'scoped, built and delivered production platforms for enterprise clients under contract. proposals, milestone plans and client-facing qa included.',
    bullets: [
      'ai navigator. enterprise ai readiness platform, live at navigator.leadingwith.ai: gpt-4o chat with action execution, 25-zone sentiment heatmap, maturity assessment framework. wrote the phase 2 proposal, now in development under contract.',
      'company challenges. enterprise learning platform, live in production: reusable content architecture (author once, deploy across unlimited cohorts), tiptap rich content editing, vercel cron lifecycle emails.',
      'diagnosed and fixed a postgrest regression within hours when a supabase platform upgrade silently broke production aggregate queries.',
    ],
  },
  {
    ...
    description:
      'ran a client practice in parallel with the studio work. enterprise saas hardening, ai application builds, workflow automation. every completed engagement rated 5.0 with verified reviews.',
    bullets: [
      'architected a fully automated ai content repurposing and publishing system: multi-platform pipeline on zapier, notion and ai generation services for a long-term retained client.',
      ...
      'designed and deployed ai sales-agent infrastructure on n8n and gohighlevel. retained for ongoing ai architecture advisory.',
    ],
  },
  {
    ...
    description:
      'owned ai-driven sales automation across the organization. the bridge role between business operations and engineering that led into full-time product work.',
    bullets: [
      'implemented ai-driven sales automation reducing customer acquisition costs by 45%',
      'built custom automation tooling that cut manual processes by 60% while holding 99.8% uptime across cross-departmental integrations',
      'trained a team of 8 on the new systems: 95% adoption rate and a 30% increase in sales productivity',
    ],
  },
  {
    ...
    description:
      'systematized outbound and appointment-booking operations at a fast-growth healthcare revenue company.',
    bullets: [
      'streamlined cold outreach and booking workflows with automated follow-ups: 35% increase in successful appointments',
      'built a targeted client acquisition strategy producing 25% growth in qualified leads. negotiated vendor contracts reducing operational costs by 20%',
    ],
  },
  {
    title: 'early career, operations and digital marketing',
    org: 'sk stones, independent e-commerce ventures',
    period: '2021 - 2022',
    type: 'full-time and independent',
    description:
      'ran multi-platform digital marketing at sk stones and built independent e-commerce operations, including a japanese import retailer that became top-trending in its category in north america (q1 2021). the operating and go-to-market grounding behind everything since.',
    bullets: [
...
const projects = [
  {
    ...
    role: 'lead engineer / 2025 - present',
  ...
  },
  {
    ...
    role: 'lead engineer, client contract / oct 2025 - present',
    status: 'live' as const,
    statusLabel: 'live, phase 2 in dev',
    url: 'https://navigator.leadingwith.ai',
    github: null,
    pdf: '/portfolio/ai-navigator-showcase.pdf',
    onePager: null,
    highlight: 'gpt-4o chat with action execution / 25-zone sentiment heatmap / capability framework',
  ...
  },
  {
    ...
    role: 'sole engineer / apr 2025 - feb 2026',
    status: 'live' as const,
  ...
  },
  {
    ...
    role: 'sole engineer, client contract / jan - jun 2026',
    status: 'live' as const,
  ...
  },
  {
    ...
    role: 'primary engineer / nov 2025 - mar 2026',
    status: 'active' as const,
    statusLabel: 'active, revenue',
    url: null,
    github: null,
  ...
  },
  {
    ...
    highlight: 'tavus video ai / claude clinical extraction / dual-path webhook completion',
  ...
  },
  {
    ...
    role: 'sole engineer / dec 2025 - present',
    status: 'pre' as const,
  ...
  {
    name: 'inflio',
    tagline: 'ai video platform, closed after validation',
    role: 'sole engineer / jun 2025 - feb 2026',
    status: 'pre' as const,
    statusLabel: 'wound down',
    url: null,
    github: 'https://github.com/DevGanuga/inflio',
    pdf: null,
    onePager: null,
    highlight: '399 typescript files, 119k loc solo / professional shutdown, clean build',
    tech: ['next.js', 'typescript', 'ai transcription', 'multi-platform publishing'],
